...
*/
#define CONFIG_BOOTCOMMAND      "lcd off;fatload mmc 0:1 40080000 image;fatload mmc 0:1 48000000 kmax.dtb;bootm 40080000 - 48000000"

#define CONFIG_BOOTCOMMAND_UFS	"lcd off;movi read scsi kernel %u 40080000;movi read scsi ramdisk %u 42000000 A00000;movi r s dtb 0 48000000;bootm 40080000 42000000 48000000"
#endif
#ifdef CONFIG_EFI_PARTITION
...
#define CONFIG_FACTORY_RESET_BOOTCOMMAND      "lcd off;fatload mmc 0:1 40080000 image;fatload mmc 0:1 48000000 kmax.dtb;bootm 40080000 - 48000000"
...
#define CONFIG_ENGMODE_RESET_BOOTCOMMAND      "lcd off;fatload mmc 0:1 40080000 image;fatload mmc 0:1 48000000 kmax.dtb;bootm 40080000 - 48000000"
