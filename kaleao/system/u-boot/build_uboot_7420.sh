...
if [ $1 = "avl7420" ]
then
#make CROSS_COMPILE=~/projects/tools/aarch64-linux-android-4.9/bin/aarch64-linux-android- distclean ${CONFIG}_SG_config
#make CROSS_COMPILE=~/projects/tools/aarch64-linux-android-4.9/bin/aarch64-linux-android- 

make CROSS_COMPILE=~/projects/tools/gcc-linaro-4.9-2014.11-x86_64_aarch64-linux-gnu/bin/aarch64-linux-gnu- distclean ${CONFIG}_SG_config
make CROSS_COMPILE=~/projects/tools/gcc-linaro-4.9-2014.11-x86_64_aarch64-linux-gnu/bin/aarch64-linux-gnu-
...
#make CROSS_COMPILE=~/projects/tools/aarch64-linux-android-4.9/bin/aarch64-linux-android- distclean ${CONFIG}_config
#make CROSS_COMPILE=~/projects/tools/aarch64-linux-android-4.9/bin/aarch64-linux-android- 

make CROSS_COMPILE=~/projects/tools/gcc-linaro-4.9-2014.11-x86_64_aarch64-linux-gnu/bin/aarch64-linux-gnu- distclean ${CONFIG}_config
make CROSS_COMPILE=~/projects/tools/gcc-linaro-4.9-2014.11-x86_64_aarch64-linux-gnu/bin/aarch64-linux-gnu-
...
then
	cat ./sd_fuse/image/bl1 ./sd_fuse/image/el3 ./$BOARD-spl.bin u-boot.bin ./sd_fuse/image/tzsw > set.bin
#	rm u-boot.bin
fi
...
then
make CROSS_COMPILE=~/projects/tools/aarch64-linux-android-4.9/bin/aarch64-linux-android- distclean ${CONFIG}_config
make  CROSS_COMPILE=~/projects/tools/aarch64-linux-android-4.9/bin/aarch64-linux-android- -j4
if [ ! -f u-boot.bin ]
then
	echo "**************************"
	echo "COMPILE error ; Please check code  !!!"
