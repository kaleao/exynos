...
#elif defined(CONFIG_CPU_EXYNOS7580)
#define USBOTG_LINK_BASE		(0x13580000)
#else
...
#elif defined(CONFIG_CPU_EXYNOS7580)
#define USBOTG_PHY_BASE			(0x135C0000)
#else
#define USBOTG_PHY_BASE			(0x125B0000) //(0xEC100000)
#endif

#if defined(CONFIG_CPU_EXYNOS7580)
#define CLK_BASE			(0x13730000)
#endif
...
#elif defined(CONFIG_CPU_EXYNOS7580)
#define USB_PHY_CONTROL_OFFSET		0x0738
#define USB_PHY_CONTROL			(EXYNOS_POWER_BASE + USB_PHY_CONTROL_OFFSET)
#else
 ...
 */
#if defined(CONFIG_CPU_EXYNOS7580)
#define EXYNOS_PHYUTMI			(USBOTG_PHY_BASE + 0x008)
#define EXYNOS_PHYCLKRST		(USBOTG_PHY_BASE + 0x010)
#define EXYNOS_HOSTPHYCTRL0		(USBOTG_PHY_BASE + 0x054)
#define EXYNOS_HOSTLINKCTRL		(USBOTG_PHY_BASE + 0x088)
#define EXYNOS_OTGLINKCTRL		(USBOTG_PHY_BASE + 0x08c)
/*for PHY USER MUX*/
#define CLK_MUX_SEL_FSYS2		(CLK_BASE + 0x208)
#define CLK_MUX_STAT_FSYS2		(CLK_BASE + 0x408)
#else
