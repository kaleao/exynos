...
struct exynos7420_power {
	unsigned int	om_stat;		/* 0x105C_0000 */
	unsigned char	res1[0x3fc];
	unsigned int	swreset;
	unsigned int	rst_stat;
	unsigned char	res2[0x304];
	unsigned int	mipi_phy_m4s4_control;
	unsigned int	mipi_phy_m4s0_control;
	unsigned int	mipi_phy_m0s2_control;
	unsigned int	mipi_phy_m0s1_control;
	...
	unsigned int	sysip_dat2;
	unsigned int	sysip_dat3;
	unsigned int	ps_hold_hw_trip;
	unsigned int	ps_hold_sw_trip;
	unsigned char	res4[0xd8];
	unsigned int	pmu_spare0;
	unsigned int	pmu_spare1;
	unsigned int	pmu_spare2;
	unsigned int	pmu_spare3;
	unsigned char	res5[0x70];
	unsigned int	irom_data_reg0;
	unsigned int	irom_data_reg1;
	unsigned int	irom_data_reg2;
	unsigned int	irom_data_reg3;
...
struct exynos7580_power {
        unsigned int    om_stat;                /* 0x1046_0000 */
        unsigned char   res1[0x30];
        unsigned int    cp_stat;
        unsigned char   res2[0x3C8];
        unsigned int    swreset;
        unsigned int    rst_stat;
	unsigned char   res3[0x1F8];
	unsigned int    wakeup_stat;
	unsigned char   res4[0x10C];
        unsigned int    mipi_phy_m4s4_control;
        unsigned int    mipi_phy_m0s2_control;
        unsigned char   res5[0xE8];
        unsigned int    inform0;
        unsigned int    inform1;
        unsigned int    inform2;
        unsigned int    inform3;
	...
	unsigned int    ps_hold_hw_trip;
	unsigned int    ps_hold_sw_trip;
        unsigned char   res6[0xD8];
        unsigned int    pmu_spare0;
        unsigned int    pmu_spare1;
        unsigned int    pmu_spare2;
        unsigned int    pmu_spare3;
        unsigned char   res7[0x70];
        unsigned int    irom_data_reg0;
        unsigned int    irom_data_reg1;
        unsigned int    irom_data_reg2;
        unsigned int    irom_data_reg3;
