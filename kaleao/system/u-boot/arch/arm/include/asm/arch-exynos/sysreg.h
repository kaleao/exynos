...
struct exynos7420_sysreg {
	unsigned char	res1[0x2910];
	unsigned int	disp_cfg_user_reg; /* Base Address + 0x2910 */
	unsigned char	res2[0x01c];
	unsigned int	mipi_dphy_con; /* Base Address + 0x2930 */
};

struct exynos7580_sysreg_disp {			/* 0x14890000 */
	unsigned char	res1[0x100C];
	unsigned int	mipi_dphy_con; /* Base Address + 0x100C */
};
#endif
