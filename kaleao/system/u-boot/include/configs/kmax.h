...
*/
#define CONFIG_BOOTCOMMAND      "lcd off; mmc rescan; fatload mmc 0:1 40080000 image;fatload mmc 0:1 50000000 kmax.dtb;bootm 40080000 - 50000000"

#define CONFIG_BOOT_RECOVERY 	"lcd off;scsi read 0 40080000 5000 10000; scsi read 0 48000000 4a11 60;bootm 40080000 - 48000000"	

#define CONFIG_BOOTCOMMAND_UFS "lcd off;scsi read 0 40080000 3C000 40000; scsi read 0 49000000 37000 800; bootm 40080000 - 49000000"
#endif
#ifdef CONFIG_EFI_PARTITION
...
#define CONFIG_FACTORY_RESET_BOOTCOMMAND      "lcd off; mmc rescan; fatload mmc 0:1 40080000 image;fatload mmc 0:1 50000000 kmax.dtb;bootm 40080000 - 50000000"
...
#define CONFIG_ENGMODE_RESET_BOOTCOMMAND      "lcd off; mmc rescan; fatload mmc 0:1 40080000 image;fatload mmc 0:1 50000000 kmax.dtb;bootm 40080000 - 50000000"
