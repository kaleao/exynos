...
#define CONFIG_CPU_EXYNOS5433		/* which is in a Exynos5433 */
#define CONFIG_CPU_EXYNOS5433_EVT1	/* which is in a Exynos5433 EVT1 */
#define CONFIG_MACH_XYREF5430		/* which is in a XYREF5430 */

#ifdef CONFIG_CPU_EXYNOS5433_EVT1
#define CONFIG_ARCH_EXYNOS7
#endif
...
#endif
#ifdef CONFIG_CPU_EXYNOS5433_EVT1
#define CONFIG_SPL_TEXT_BASE		0x0203B000
#else
...
/* TRIP_DATA */
#define LATCHED_SW_TRIP_DATA	0x1
#define LATCHED_HW_TRIP_DATA	0x2
#define LATCHED_SWHW_TRIP_DATA	0x3
...
#define CONFIG_BOOTCOMMAND_UFS	"movi read scsi kernel %u 20008000;movi read scsi rootfs %u 21000000 100000;bootz 20008000 21000000"
#endif

#define CONFIG_RECOVERYCOMMAND	\
		"movi r s 1 40000000;"	\
		"emmc open 0;"	\
		"movi w z s 0 40000000;"	\
		"emmc close 0;"	\
		"reset"
...
#ifdef CONFIG_CPU_EXYNOS5433
#define CONFIG_SYS_PROMPT		"XYREF5433 # "
#else
...
#ifdef CONFIG_CPU_EXYNOS5433
#define CONFIG_IDENT_STRING		" for XYREF5433"
#else
...
#ifdef CONFIG_CPU_EXYNOS5433
#define CONFIG_IRAM_STACK	0x0207C000
#else
