...
#define CONFIG_SG_BINARY			/* for Sleep Go bl2 */
...
#define CONFIG_GPT_ENV_7420 \
		...
		"name=system,size=800MiB,start=0x6400000,uuid=${uuid_system};"\
		"name=userdata,size=28000MiB,uuid=${uuid_userdata};"\
		"name=cache,size=800MiB,uuid=${uuid_cache};"\
		"name=environment,size=16KiB,start=0x13C000,uuid=${uuid_env};"\
		"name=kernel,size=20MiB,uuid=${uuid_kernel};"\
...
#else
#define CONFIG_BOOTCOMMAND	"movi read kernel 0 40080000;movi read ramdisk 0 42000000 A00000;movi r dtb 0 48000000;bootm 40080000 42000000 48000000"
#define CONFIG_BOOTCOMMAND_UFS	"movi read scsi kernel %u 40080000;movi read scsi ramdisk %u 42000000 A00000;movi r s dtb 0 48000000;bootm 40080000 42000000 48000000"
#endif
#ifdef CONFIG_EFI_PARTITION
 #define CONFIG_RECOVERYCOMMAND	\
		"emmc partition 0 10 0;"	\
		"movi r b 1 40000000;emmc open 0;movi w z set 0 40000000;emmc close 0;"
