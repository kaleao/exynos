...
} __attribute__ ((__packed__)) block_dev_desc_t;
...
typedef struct disk_partition {
	...
	ulong	start_p;		/* # of first block in partition	*/
	ulong	size_p;		/* number of blocks in partition	*/
	ulong	blksz_p;		/* block size in bytes			*/
#endif
