...
#ifndef DISP_RESOL
#define DISP_RESOL 3  /* 1=INT_FHD_EXT_UHD(without MIC), 2=INT_WQHD_EXT_UHD(1/2 MIC), 3=INT_WQXGA_EXT_UHD(1/2 MIC) */
#endif
...
//	#define SCLK_HDMI_SPDIF_RATIO				3	/* 100MHz = BUS0_PLL 400MHz/(3+1) */ //400
    ...
    #if defined(CONFIG_DECON_LCD_S6E8FA0X01) || defined(CONFIG_DECON_LCD_S6E3FA0)
	#define SCLK_DECON_INT_EXTCLKPLL_SUB_RATIO	1	/* 134MHz = DISP_PLL 134MHz/(0+1), VCLK */
    #else
    #define SCLK_DECON_INT_EXTCLKPLL_SUB_RATIO  3   /* 134MHz = DISP_PLL 134MHz/(0+1), VCLK */
    #endif
	#define SCLK_DECON_EXT_ECLK_RATIO			3	/* 167MHz = BUS1_PLL 668MHz/(3+1) */
	#define SCLK_DSD_RATIO						3	/* 167MHz = BUS1_PLL 668MHz/(3+1) */
//	#define SCLK_HDMI_SPDIF_RATIO				3	/* 100MHz = BUS0_PLL 400MHz/(3+1) */ //400
