...
static const struct samsung_pll_rate_table pll1450x_24mhz_atlas_tbl[] __initconst= {
	/* rate, m, p, s */
		PLL_35XX_RATE(2496000000U, 208, 2,  0),
		PLL_35XX_RATE(2400000000U, 200, 2,  0),
		PLL_35XX_RATE(2304000000U, 192, 2,  0),
		PLL_35XX_RATE(2200000000U, 275, 3,  0),
		PLL_35XX_RATE(2100000000U, 175, 2,  0),
		PLL_35XX_RATE(2000000000U, 250, 3,  0),
		PLL_35XX_RATE(1896000000U, 158, 2,  0),
		PLL_35XX_RATE(1800000000U, 150, 2,  0),
		PLL_35XX_RATE(1704000000U, 142, 2,  0),
		PLL_35XX_RATE(1600000000U, 200, 3,  0),
		PLL_35XX_RATE(1500000000U, 250, 2,  1),
		PLL_35XX_RATE(1400000000U, 350, 3,  1),
		PLL_35XX_RATE(1300000000U, 325, 3,  1),
		PLL_35XX_RATE(1200000000U, 200, 2,  1),
		PLL_35XX_RATE(1100000000U, 275, 3,  1),
		PLL_35XX_RATE(1000000000U, 250, 3,  1),
		PLL_35XX_RATE(900000000U, 150, 2,  1),
		PLL_35XX_RATE(800000000U, 200, 3,  1),
		PLL_35XX_RATE(700000000U, 350, 3,  2),
		PLL_35XX_RATE(600000000U, 200, 2,  2),
		PLL_35XX_RATE(500000000U, 250, 3,  2),
		PLL_35XX_RATE(400000000U, 200, 3,  2),
		PLL_35XX_RATE(300000000U, 200, 2,  3),
		PLL_35XX_RATE(200000000U, 200, 3,  3),
};


static const struct samsung_pll_rate_table pll1450x_24mhz_tbl_apollo[] __initconst= {
	/* rate, m, p, s */
		PLL_35XX_RATE(1800000000U, 150, 2,  0),
		PLL_35XX_RATE(1704000000U, 142, 2,  0),
		PLL_35XX_RATE(1600000000U, 200, 3,  0),
		PLL_35XX_RATE(1500000000U, 250, 4,  0),
		PLL_35XX_RATE(1400000000U, 175, 3,  0),
		PLL_35XX_RATE(1296000000U, 108, 2,  0),
		PLL_35XX_RATE(1200000000U, 100, 2,  0),
		PLL_35XX_RATE(1104000000U, 92,  2,  0),
		PLL_35XX_RATE(1000000000U, 125, 3,  0),
		PLL_35XX_RATE(900000000U, 150, 2,  1),
		PLL_35XX_RATE(800000000U, 200, 3,  1),
		PLL_35XX_RATE(700000000U, 175, 3,  1),
		PLL_35XX_RATE(600000000U, 100, 2,  1),
		PLL_35XX_RATE(500000000U, 125, 3,  1),
		PLL_35XX_RATE(400000000U, 200, 3,  2),
		PLL_35XX_RATE(300000000U, 100, 2,  2),
		PLL_35XX_RATE(200000000U, 200, 3,  3),
};


static const struct samsung_pll_rate_table pll1450x_24mhz_tbl_mif[] __initconst= {
	/* rate, m, p, s */
		PLL_35XX_RATE(3104000000U,   388, 3, 0),
       		PLL_35XX_RATE(2912000000U,   364, 3, 0),
	       	PLL_35XX_RATE(2528000000U,   316, 3, 0),
	        PLL_35XX_RATE(2136000000U,   178, 2, 0),
	        PLL_35XX_RATE(2052000000U,   171, 2, 0),
       		PLL_35XX_RATE(1656000000U,   207, 3, 0),
	        PLL_35XX_RATE(1264000000U,   316, 3, 1),
	        PLL_35XX_RATE(1086000000U,   181, 2, 1),
	        PLL_35XX_RATE(832000000U,    208, 3, 1),
	        PLL_35XX_RATE(696000000U,    348, 3, 2),
	        PLL_35XX_RATE(552000000U,    276, 3, 2),
	        PLL_35XX_RATE(334000000U,    334, 3, 3),
	        PLL_35XX_RATE(266000000U,    266, 3, 3),
	        PLL_35XX_RATE(200000000U,    200, 3, 3),

};

static const struct samsung_pll_rate_table pll1450x_24mhz_tbl[] __initconst= {
	/* rate, m, p, s */
		PLL_35XX_RATE(2100000000U, 175, 2,  0),
		PLL_35XX_RATE(2000000000U, 250, 3,  0),
		PLL_35XX_RATE(1896000000U, 158, 2,  0),
...
static const struct samsung_gate_clock topc_gate_clks[] __initconst = {
	...
	GATE(SCLK_BUS0_PLL_ATLAS, "sclk_bus0_pll_atlas", "mout_topc_bus0_pll_atlas",
		 ENABLE_SCLK_TOPC1, 0, 0, 0),
};
...
static const struct samsung_mux_clock atlas_mux_clks[] __initconst = {
		...
		MUX_F(MOUT_SCLK_BUS0_PLL_ATLAS_USER, "mout_sclk_bus0_pll_atlas_user",
				mout_sclk_bus0_pll_atlas_user_p, MUX_SEL_ATLAS1,0,1, CLK_SET_RATE_PARENT, 0),

		/* MUX_SEL_ATLAS2 */
		MUX_F(MOUT_ATLAS, "mout_atlas", mout_atlas_p, MUX_SEL_ATLAS2,
...
static const struct samsung_pll_clock atlas_pll_clks[] __initconst = {
	PLL(pll_1450x, FOUT_ATLAS_PLL, "fout_atlas_pll", "fin_pll",
		...
		/*pll1450x_24mhz_tbl*/ pll1450x_24mhz_atlas_tbl),
};
...
static void __init exynos7_clk_atlas_init(struct device_node *np)
{
	...
	exynos_register_cpu_clock(ctx, CLK_ATLAS_CLK, "atlclk",
		...
		CLK_CPU_HAS_E7420_REGS_LAYOUT | CLK_CPU_HAS_MODIFIED_MUX_STAT );
...
/* List of parent clocks for Muxes in CMU_ATLAS */
PNAME(mout_apollo_pll_p) = { "fin_pll", "fout_apollo_pll" };
PNAME(mout_sclk_bus0_pll_apollo_user_p) = { "fin_pll", "sclk_bus0_pll_apollo" };
PNAME(mout_apollo_p) = { "mout_apollo_pll", "mout_sclk_bus0_pll_apollo_user" };
...
static const struct samsung_mux_clock apollo_mux_clks[] __initconst = {
	/* MUX_SEL_ATLAS0 */
	MUX_F(MOUT_APOLLO_PLL, "mout_apollo_pll", mout_apollo_pll_p,
			MUX_SEL_APOLLO0, 0, 1, CLK_SET_RATE_PARENT |
			CLK_RECALC_NEW_RATES, 0),

		/* MUX_SEL_APOLLO1 */
		MUX(MOUT_SCLK_BUS0_PLL_APOLLO_USER, "mout_sclk_bus0_pll_apollo_user",
			mout_sclk_bus0_pll_apollo_user_p, MUX_SEL_APOLLO1,
			0, 1),

		/* MUX_SEL_APOLLO2 */
		MUX_F(MOUT_APOLLO, "mout_apollo", mout_apollo_p,
			MUX_SEL_APOLLO2, 0, 1, CLK_SET_RATE_PARENT, 0),
	};

	static const struct samsung_div_clock apollo_div_clks[] __initconst = {
		/* DIV_APOLLO0 */
		DIV_F(DOUT_CNTCLK_APOLLO, "dout_cntclk_apollo", "dout_apollo2",
			DIV_APOLLO0, 24, 5, CLK_GET_RATE_NOCACHE, CLK_DIVIDER_READ_ONLY),
		DIV_F(DOUT_PCLK_DBG_CLK_APOLLO, "dout_pclk_dbg_apollo", "dout_apollo2",
			DIV_APOLLO0, 20, 5, CLK_GET_RATE_NOCACHE, CLK_DIVIDER_READ_ONLY),
		DIV_F(DOUT_ATCLK_APOLLO, "dout_atclk_apollo", "dout_apollo2",
			DIV_APOLLO0, 16, 5, CLK_GET_RATE_NOCACHE, CLK_DIVIDER_READ_ONLY),
		DIV_F(DOUT_PCLK_APOLLO, "dout_pclk_apollo", "dout_apollo2",
			DIV_APOLLO0, 12, 5, CLK_GET_RATE_NOCACHE, CLK_DIVIDER_READ_ONLY),
		DIV_F(DOUT_ACLK_APOLLO, "dout_aclk_apollo", "dout_apollo2",
			DIV_APOLLO0, 8, 5, CLK_GET_RATE_NOCACHE, CLK_DIVIDER_READ_ONLY),
		DIV_F(DOUT_APOLLO2, "dout_apollo2", "dout_apollo1",
			DIV_APOLLO0, 4, 5, CLK_GET_RATE_NOCACHE, CLK_DIVIDER_READ_ONLY),
		DIV_F(DOUT_APOLLO1, "dout_apollo1", "mout_apollo",
			DIV_APOLLO0, 0, 5, CLK_GET_RATE_NOCACHE, CLK_DIVIDER_READ_ONLY),

		/* DIV_APOLLO1 */
		DIV_F(DOUT_SCLK_HPM_APOLLO, "dout_sclk_hpm_apollo", "mout_apollo",
			DIV_APOLLO1, 4, 5, CLK_GET_RATE_NOCACHE, CLK_DIVIDER_READ_ONLY),
		DIV_F(DOUT_APOLLO_PLL, "dout_apollo_pll", "mout_apollo",
			DIV_APOLLO1, 0, 5, CLK_GET_RATE_NOCACHE, CLK_DIVIDER_READ_ONLY),
	};

	static const struct samsung_gate_clock apollo_gate_clks[] __initconst = {
		//GATE(CLK_APOLLO, "apolloclk", "dout_apollo2",
		//	ENABLE_SCLK_APOLLO, 0, CLK_IGNORE_UNUSED, 0),

			/* ENABLE_ACLK_APOLLO */
			GATE(CLK_ACLK_ASATBSLV_APOLLO_3_CSSYS, "aclk_asatbslv_apollo_3_cssys",
					"dout_atclk_apollo", ENABLE_ACLK_APOLLO,
					6, 0, 0),
			...
			GATE(CLK_ACLK_ASYNCACES_APOLLO_CCI, "aclk_asyncaces_apollo_cci",
					"dout_aclk_apollo", ENABLE_ACLK_APOLLO,
					2, 0, 0),
			GATE(CLK_ACLK_AHB2APB_APOLLOP, "aclk_ahb2apb_apollop",
					"dout_pclk_apollo", ENABLE_ACLK_APOLLO,
					1, 0, 0),
			...
			GATE(CLK_PCLK_ASAPBMST_CSSYS_APOLLO, "pclk_asapbmst_cssys_apollo",
					"dout_pclk_dbg_apollo", ENABLE_PCLK_APOLLO,
					2, 0, 0),
			GATE(CLK_PCLK_PMU_APOLLO, "pclk_pmu_apollo", "dout_pclk_apollo",
					ENABLE_PCLK_APOLLO, 1, 0, 0),
			GATE(CLK_PCLK_SYSREG_APOLLO, "pclk_sysreg_apollo",
					"dout_pclk_apollo", ENABLE_PCLK_APOLLO,
					0, 0, 0),

			/* ENABLE_SCLK_APOLLO */
			GATE(CLK_CNTCLK_APOLLO, "cntclk_apollo", "dout_cntclk_apollo",
					ENABLE_SCLK_APOLLO, 3, 0, 0),
			GATE(CLK_SCLK_HPM_APOLLO, "sclk_hpm_apollo", "dout_sclk_hpm_apollo",
					ENABLE_SCLK_APOLLO, 1, 0, 0),
	};

	static const struct samsung_pll_clock apollo_pll_clks[] __initconst = {
		PLL(pll_35xx, FOUT_APOLLO_PLL, "fout_apollo_pll", "fin_pll",
			APOLLO_PLL_LOCK, APOLLO_PLL_CON0,
			/*pll1450x_24mhz_tbl*/pll1450x_24mhz_tbl_apollo),
	};


	#define EXYNOS7_APL_DIV0(cntclk, pclk_dbg, atclk, pclk, aclk) \
		(((cntclk) << 24) | ((pclk_dbg) << 20) | ((atclk) << 16) | \
		 ((pclk) << 12) | ((aclk) << 8))

	#define EXYNOS7_APL_DIV1(hpm, copy) \
		(((hpm) << 4) | ((copy) << 0))

	static const struct exynos_cpuclk_cfg_data exynos7_apolloclk_d[] __initconst = {
		{ 1500000, EXYNOS7_APL_DIV0(2, 5, 5, 5 ,5), EXYNOS7_APL_DIV1(1, 4), },
		{ 1400000, EXYNOS7_APL_DIV0(2, 5, 5, 5 ,5), EXYNOS7_APL_DIV1(1, 4), },
		{ 1296000, EXYNOS7_APL_DIV0(2, 5, 5, 5 ,5), EXYNOS7_APL_DIV1(1, 4), },
		{ 1200000, EXYNOS7_APL_DIV0(2, 5, 5, 5 ,5), EXYNOS7_APL_DIV1(1, 3), },
		{ 1104000, EXYNOS7_APL_DIV0(1, 5, 5, 5 ,5), EXYNOS7_APL_DIV1(1, 3), },
		{ 1000000, EXYNOS7_APL_DIV0(1, 5, 5, 5 ,5), EXYNOS7_APL_DIV1(1, 3), },
		{  900000, EXYNOS7_APL_DIV0(1, 5, 5, 5 ,5), EXYNOS7_APL_DIV1(1, 3), },
		{  800000, EXYNOS7_APL_DIV0(1, 5, 5, 5 ,5), EXYNOS7_APL_DIV1(1, 2), },
		{  700000, EXYNOS7_APL_DIV0(1, 4, 4, 4 ,4), EXYNOS7_APL_DIV1(1, 2), },
		{  600000, EXYNOS7_APL_DIV0(1, 4, 4, 4 ,4), EXYNOS7_APL_DIV1(1, 2), },
		{  500000, EXYNOS7_APL_DIV0(1, 4, 4, 4 ,4), EXYNOS7_APL_DIV1(1, 2), },
		{  400000, EXYNOS7_APL_DIV0(2, 3, 3, 3 ,3), EXYNOS7_APL_DIV1(1, 2), },
		{  300000, EXYNOS7_APL_DIV0(2, 3, 3, 3 ,3), EXYNOS7_APL_DIV1(1, 2), },
		{  200000, EXYNOS7_APL_DIV0(2, 3, 3, 3 ,3), EXYNOS7_APL_DIV1(1, 1), },
		{  0 },
	};

	static void __init exynos7_clk_apollo_init(struct device_node *np)
	{
		void __iomem *reg_base;
		struct samsung_clk_provider *ctx;
		...
		exynos_register_cpu_clock(ctx, CLK_APOLLO_CLK, "apolloclk",
			mout_apollo_p[0], mout_apollo_p[1], 0x200,
			exynos7_apolloclk_d, ARRAY_SIZE(exynos7_apolloclk_d),
			CLK_CPU_HAS_E7420_REGS_LAYOUT | CLK_CPU_HAS_MODIFIED_MUX_STAT);
	...
	CLK_OF_DECLARE(exynos7_clk_apollo, "samsung,exynos7-clock-apollo",
			exynos7_clk_apollo_init);
