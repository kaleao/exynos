...
#define VPP_ROT 		4
#define CAM_FACTOR 		3
#define MIF_ROT_UTIL		18
#define MIF_ROT_UTIL2		30
#define MIF_ROT_UTIL3		34
#define MIF_UTIL		50
#define MIF_UTIL2		60
...
void exynos7_update_media_scenario(enum bts_media_type media_type, unsigned int bw, unsigned int rot);
