...
#define EXYNOS7410_SOC_ID	0xE7410000
#define EXYNOS7420_SOC_ID	0xE7420000
#define EXYNOS7580_SOC_ID	0xE7580000
#define EXYNOS7_SOC_MASK	0xFFFF0000
...
IS_SAMSUNG_CPU(exynos7410, EXYNOS7410_SOC_ID, EXYNOS7_SOC_MASK)
IS_SAMSUNG_CPU(exynos7420, EXYNOS7420_SOC_ID, EXYNOS7_SOC_MASK)
IS_SAMSUNG_CPU(exynos7580, EXYNOS7580_SOC_ID, EXYNOS7_SOC_MASK)
...
#if defined(CONFIG_SOC_EXYNOS7410)
# define soc_is_exynos7410()	is_samsung_exynos7410()
#else
# define soc_is_exynos7410()	0
#endif
...
# define soc_is_exynos7580()	is_samsung_exynos7580()
#else
# define soc_is_exynos7580()	0
#endif
